...
features:
  - icon: 🛡️
    title: Простые приваты
    details: Забудь про топор и просто поставь защитный блок для мгновенного создания региона.
    link: /features/privates

  - icon: 💎
    title: Живая экономика
    details: Создавай магазины, торгуй на аукционе и получай валюту за время в игре.
    link: /info/economy

  - icon: ⚔️
    title: Уникальный геймплей
    details: Изучай новые крафты, создавай кланы и забирай свои ежедневные награды.
    link: /info/about
